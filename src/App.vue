			...
			<div class="card-body">
				...
				<div class="section" :class="{ inactive: !selectedSignId }">
					...
					<div class="toggle-container">
						<div class="toggle-switch" :class="{ off: !displayPower, disabled: !selectedSignId }" @click="togglePower">
				...
				<div class="section">
					...
					<select v-model="selectedSignId" @change="onSignChange" class="sign-selector">
						...
						<option v-for="signId in availableSigns" :key="signId" :value="signId">LED Sign {{ signId }}</option>
					</select>
				</div>
			</div>
		</div>
